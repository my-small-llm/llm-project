...
GOLD_CATEGORIES = {
    ...
    "엣지 케이스": {
        "count": 10,
        "instruction": "고객의 입력이 극도로 비정형적인 엣지 케이스 대화를 생성하십시오. 심각한 오타('치긴 벅고십다', '짲장묜 배달'), 중간에 지시 번복('피자 줘... 아 아니 막국수로 변경'), 아주 모호한 지시('제일 싼거 아무거나', '다들 많이 먹는걸로 줘') 등 모델의 추론 능력을 한계까지 시험하는 다양하고 기상천외한 상황을 매번 새롭게 만들어 내십시오. 단, search_restaurants에서는 query/category 규칙을 엄격히 지키십시오: 고정 taxonomy(한식/중식/일식/분식/카페/야식)는 category, 메뉴명/요리명/브랜드명/식당명은 query에 넣고, 마지막으로 정정된 의도만 반영하십시오."
    }
}
